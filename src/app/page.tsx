...
const SERVICES = [
  ...
  { icon: Cpu,             name: "Business Automation",      desc: "Authority13 — commander delegates to specialists for marketing, ops, support, and analytics. $49 / $149 / $299 tiers.", tag: "Flagship" },
